...
$('.slider-nav').on('afterChange', function(event, slick, currentSlide){
 ...
 $('.slider-dots li:nth-of-type(1) button').css("background" , "url(../TenTwenty_test/assets/images/img2.jpg)");
 $('.slider-dots li:nth-of-type(2) button').css("background" , "url(../TenTwenty_test/assets/images/img3.jpg)");
 $('.slider-dots li:nth-of-type(3) button').css("background" , "url(../TenTwenty_test/assets/images/img1.jpg)");
