  jQuery(document).ready(function(){
   jQuery(function(){jQuery("#header").load("../TenTwenty_test/templates/header.html"),jQuery("#footer").load("../TenTwenty_test/templates/footer.html")});
const myTimeout=setTimeout(myGreeting,500);function myGreeting(){jQuery(".contact-btn").hover(function(){jQuery(this).find("img").css({right:"10px",transition:"0.5s ease"})},function(){jQuery(this).find("img").css({right:"16px",transition:"0.5s ease"})})}
$(".slider-nav").slick({pauseOnHover:!1,slidesToShow:1,slidesToScroll:1,dots:!0,autoplay:!1,autoplaySpeed:5e3,focusOnSelect:!0,arrows:!1,appendDots:$(".slider-dots-box"),dotsClass:"slider-dots"});
...
jQuery(".slick-new").slick({dots:!1,infinite:!0,touchThreshold:100,speed:300,slidesToShow:3,slidesToScroll:3,centerMode:!0,nextArrow:'<button class="slick-next"><i class="fas fa-chevron-right"></i></button>',prevArrow:'<button class="slick-prev"><i class="fas fa-chevron-left"></i></button>',responsive:[{breakpoint:1024,settings:{slidesToShow:3,slidesToScroll:3}},{breakpoint:600,settings:{slidesToShow:1,slidesToScroll:3}},{breakpoint:480,settings:{slidesToShow:1,slidesToScroll:1}}]});
